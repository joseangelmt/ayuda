...
Exporta el archivo actual BIND a los formatos:
...
Las entidades que estén registradas con un código que está apagado \([OFF](off.md)\), en el momento de ejecutar la orden, no serán incluidas en el archivo exportado.
