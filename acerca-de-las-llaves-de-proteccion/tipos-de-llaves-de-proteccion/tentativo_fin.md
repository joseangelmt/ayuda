...
Si está activa, finaliza automáticamente el registro de un elelento lineal cuando se acepta un tentativo sobre otra entidad.
...
| Tipo de orden | [Variable booleana](tentativo_fin.md) |
| :--- | :--- |
