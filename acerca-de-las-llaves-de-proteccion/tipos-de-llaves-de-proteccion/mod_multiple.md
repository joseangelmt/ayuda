...
En este proceso, la cota de los puntos de la entidad modificadora se ajusta a la de la entidad modificada. Si no deseas modificar las cotas utiliza la orden [MOD\_Z\_MULTIPLE](mod_z_multiple.md).
...
| Tipo de orden | [Orden interactiva](mod_multiple.md) |
| :--- | :--- |
