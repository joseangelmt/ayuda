...
Desactiva el código \(o códigos\) que no se desean visualizar en la pantalla de visión estereoscópica.
...
En el caso de que se quiera desactivar la visualización en la pantalla de dibujo, se pueden emplear las órdenes [OFF](off.md) u [OFFD](offd.md).
...
| Tipo de orden | [Orden interactiva](offs.md) |
| :--- | :--- |
