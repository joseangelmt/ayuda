...
Si está activada, tanto en restitución como en edición, todas las entidades que genere cualquier orden como puedan ser [COPIAR](copiar.md), [COPIA2P](copia2p.md), [INS](ins.md), ... se guardarán con el _código activo_ [COD](cod.md) en el momento de la ejecución de dichas órdenes.
...
| Tipo de orden | [Variable booleana](forzar_codigo_activo.md) |
| :--- | :--- |
