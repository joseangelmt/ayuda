...
Para ejecutar esta orden hace falta establecer el valor del [ángulo activo](2p_aa.md) \([AA](aa.md)\).
...
| Tipo de orden | [Orden interactiva](2p_aa.md) |
| :--- | :--- |
...
| Variables relacionadas | [AA](aa.md), REPITE |
