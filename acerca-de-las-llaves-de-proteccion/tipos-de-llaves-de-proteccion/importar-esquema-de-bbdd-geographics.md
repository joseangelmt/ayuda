...
Para crear automáticamente el esquema de una base de datos en formato Geographics, realizaremos los siguientes pasos:

1. Seleccionamos la opción del menú **BASE DE DATOS/Tablas/Importar esquema de una base de datos en formato Geographics...** Aparecerá el cuadro de diálogo **Cadena de conexión**.
...
Si no hay errores en la BBDD y esta está en formato Geographics, aparecerán automáticamente todas las tablas de la BBDD importada en la pestaña **Base de datos.**
